CREATE PROCEDURE PROC_CRAWLING_AP1_IM_PT1
...
*/
/*
Update na ODS de Registros maiores que 11 caracteres em HEIGHT, provisorio
*/
update
"OW_LAO"."ODS_CRAWLING_AP1_IM_PRODUCT_DETAIL"
set "HEIGHT" = left ("HEIGHT" ,5)
where length ("HEIGHT" )> 11;
/*
Update na ODS de Registros maiores que 11 caracteres em WIDTH, provisorio
Data de inclusão 12/01/2023
*/
update
"OW_LAO"."ODS_CRAWLING_AP1_IM_PRODUCT_DETAIL"
set "WIDTH" = left ("WIDTH" ,5)
where length ("WIDTH" )> 19;
TRUNCATE TABLE TF_CRAWLING_AP1_IM_1;
INSERT INTO TF_CRAWLING_AP1_IM_1
SELECT DISTINCT
...
WHERE 1=1
AND to_char(P."TODAY_DATE_TIME", 'YYYY-MM-DD')  BETWEEN to_char(add_days(CURRENT_DATE,-20), 'YYYY-MM-DD') and  to_char(add_days(CURRENT_DATE,-1), 'YYYY-MM-DD')
...
MERGE INTO TF_CRAWLING_AP1_IM_1 O
USING (
SELECT * FROM (
SELECT DISTINCT 
...
;
-- Etapa: 1
TRUNCATE TABLE TF_CRAWLING_AP1_IM_2;
INSERT INTO TF_CRAWLING_AP1_IM_2
	SELECT 
		DENSE_RANK() OVER (
...
TRUNCATE TABLE TF_CRAWLING_AP1_IM_3;
INSERT INTO TF_CRAWLING_AP1_IM_3
	SELECT
...
-- Etapa: 3
TRUNCATE TABLE TF_CRAWLING_AP1_IM_4;
INSERT INTO TF_CRAWLING_AP1_IM_4
SELECT 
	brand_nm,
	model_nm,	
	idxbyrsnmodelnm,
...
TRUNCATE TABLE TF_CRAWLING_AP1_IM_5;
_loopnum := 715;
i := 1;
	...
	_case_str := 'case' || i ;
_vp_query := '
		INSERT INTO TF_CRAWLING_AP1_IM_5
		SELECT'
