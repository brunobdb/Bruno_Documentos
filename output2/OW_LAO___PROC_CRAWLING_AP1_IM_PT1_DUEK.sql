CREATE PROCEDURE PROC_CRAWLING_AP1_IM_PT1_DUEK
...
WHERE 1=1
AND to_char(P."TODAY_DATE_TIME", 'YYYY-MM-DD')  BETWEEN to_char(add_days(CURRENT_DATE,-15), 'YYYY-MM-DD') and  to_char(CURRENT_DATE, 'YYYY-MM-DD')
