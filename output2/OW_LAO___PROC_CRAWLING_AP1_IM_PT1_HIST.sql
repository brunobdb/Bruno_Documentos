CREATE   PROCEDURE PROC_CRAWLING_AP1_IM_PT1_HIST
...
WHERE 1=1
--AND to_char(P."TODAY_DATE_TIME", 'YYYY-MM-DD')  BETWEEN to_char(add_days(CURRENT_DATE,-4), 'YYYY-MM-DD') and  to_char(CURRENT_DATE, 'YYYY-MM-DD') 
AND to_char(P."TODAY_DATE_TIME", 'YYYY-MM-DD')  BETWEEN to_char(add_days(CURRENT_DATE,-365), 'YYYY-MM-DD') and to_char(add_days(CURRENT_DATE,-16), 'YYYY-MM-DD')
