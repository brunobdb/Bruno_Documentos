CREATE PROCEDURE OW_SEDA_S.PROC_OST_AFTERSALES_REFUND_TEMP_EPP2ESTUDANTES
--
...
BEGIN
	...
	IF EXISTS(  SELECT TABLE_NAME
				 ...
				 WHERE SCHEMA_NAME = 'OW_SEDA_S' 
				   AND TABLE_NAME  = 'TMP_OST_REFUND_6'
		     ) THEN 
			 DROP TABLE OW_SEDA_S.TMP_OST_REFUND_6;
	END IF;
    --  
	CREATE COLUMN TABLE OW_SEDA_S.TMP_OST_REFUND_6 
			/*
