...
CREATE PROCEDURE OW_SEDA_S.PRC_WEBPRICE_HOURLY_MX_HIST_2 (IN PREVIOUS_DAYS INT) AS
--DO 
BEGIN
...
WHERE TO_DATE(ocwa.INPUT_DATE) BETWEEN TO_DATE('2025-04-05') AND TO_DATE('2025-04-06');
tmp_complete = 
SELECT
	tmx.MARCA,
	tmx.CATEGORY,
