CREATE PROCEDURE OW_SEDA_S.PRC_VC_UPDATE_READY (WEEKNUM_REF INT) AS 
--DO 
BEGIN
...
WHERE 1=1
	AND EXISTS (SELECT 1 FROM OW_SEDA_S.MAP_CE_PRODUCTS mcp WHERE fcp.ITEM = mcp.ITEM AND mcp.CATEGORY_ITEM = 'VC')
