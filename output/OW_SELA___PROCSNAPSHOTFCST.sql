CREATE PROCEDURE "OW_SELA"."PROCSNAPSHOTFCST"
LANGUAGE SQLSCRIPT as
BEGIN
---- TRUNCATE TEMPORARY TABLES-----
TRUNCATE TABLE "OW_SELA"."TMP_DLAKE_HIST";
TRUNCATE TABLE "OW_SELA"."TMP_DLAKE_W3";
TRUNCATE TABLE "OW_SELA"."TMP_DLAKE_W8";
---- INSERT TEMPORARY TABLES------
INSERT INTO "OW_SELA"."TMP_DLAKE_HIST" (SELECT * FROM "_SYS_BIC"."DLAKE_DMS/DMS_HIST");
INSERT INTO "OW_SELA"."TMP_DLAKE_W3" (SELECT * FROM "_SYS_BIC"."DLAKE_DMS/DMS_FCST_W3");
INSERT INTO "OW_SELA"."TMP_DLAKE_W8" (SELECT * FROM "_SYS_BIC"."DLAKE_DMS/DMS_FCST_W8");
--- TRUNCATE FORECAST ----------
