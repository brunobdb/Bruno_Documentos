--drop PROCEDURE OW_SEDA_S.PROC_FT_OST_AFTERSALES_REFUND_TEMP_BRSHOP
--
--------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------
--
--CREATE OR REPLACE PROCEDURE OW_SEDA_S.PROC_OST_AFTERSALES_REFUND_TEMP_BRSHOP
--CREATE OR REPLACE PROCEDURE OW_SEDA_S.PROC_OST_AFTERSALES_REFUND_TEMP_BRB2B
--CREATE OR REPLACE PROCEDURE OW_SEDA_S.PROC_OST_AFTERSALES_REFUND_TEMP_BREA
--CREATE OR REPLACE PROCEDURE OW_SEDA_S.PROC_OST_AFTERSALES_REFUND_TEMP_BRSHOPMKTPL
--CREATE OR REPLACE PROCEDURE OW_SEDA_S.PROC_OST_AFTERSALES_REFUND_TEMP_BREPP2
--CREATE OR REPLACE PROCEDURE OW_SEDA_S.PROC_OST_AFTERSALES_REFUND_TEMP_EPP2ESTUDANTES
--CREATE OR REPLACE PROCEDURE OW_SEDA_S.PROC_OST_AFTERSALES_REFUND_TEMP_EPP2MEMBERS
--CREATE OR REPLACE PROCEDURE OW_SEDA_S.PROC_OST_AFTERSALES_REFUND_TEMP_EPP2PARCERIAS
--CREATE OR REPLACE PROCEDURE OW_SEDA_S.PROC_OST_AFTERSALES_REFUND_TEMP_EPP2RESIDENCIAL
--CREATE OR REPLACE PROCEDURE OW_SEDA_S.PROC_OST_AFTERSALES_REFUND_TEMP_BRSHOP
--
CREATE PROCEDURE OW_SEDA_S.PROC_OST_AFTERSALES_REFUND_TEMP_EPP2MEMBERS
--
...
BEGIN
	...
	IF EXISTS(  SELECT TABLE_NAME
				 ...
				 WHERE SCHEMA_NAME = 'OW_SEDA_S' 
				   AND TABLE_NAME  = 'TMP_OST_REFUND_7'
		     ) THEN 
			 DROP TABLE OW_SEDA_S.TMP_OST_REFUND_7;
	END IF;
    --  
	CREATE COLUMN TABLE OW_SEDA_S.TMP_OST_REFUND_7 
			/*
