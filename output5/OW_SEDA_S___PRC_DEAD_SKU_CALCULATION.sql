CREATE PROCEDURE OW_SEDA_S.PRC_DEAD_SKU_CALCULATION(in weeknum_ref int, in category_ref varchar(10), in account_ref varchar(30)) as
begin
...
using (
select 
'Dead SKU' as "PARAMETER",
tb1."WEEKNUM",
tb1."SITE_ID",
tb1."ITEM",
1 as "DATA",
'Dead SKU Manual' as "REPORT",
...
where 
	...
	days_between(tb5."CALENDAR", tb4."CALENDAR")/7 - 1 >=8 and
	"DATA" > 1 and
